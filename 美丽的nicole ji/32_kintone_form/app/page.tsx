  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-md w-full max-w-lg p-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">问询表单</h1>
        <p className="text-sm text-gray-500 mb-6">提交后数据将保存到 Kintone</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="请输入问询内容"
              rows={4}
              className={`w-full border rounded-lg px-4 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none ${
